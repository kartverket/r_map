...
exports.OLStylesMeasure = exports.OLStylesSLD = exports.OLStylesJson = exports.OLStylesDefault = undefined;
...
var OLStylesDefault = exports.OLStylesDefault = function OLStylesDefault() {
    var styles = function styles() {
        var fill = new _Style2.default.Fill({
            color: 'rgba(255,0,0,0.8)'
        });
        var stroke = new _Style2.default.Stroke({
            color: '#3399CC',
            width: 2.25
        });
        return [new _Style2.default.Style({
...
var OLStylesJson = exports.OLStylesJson = function OLStylesJson(style) {
    var _zIndex = 0;

    function _createStyle(feature, jsonstyle, hover) {
        var jsonobject = (typeof jsonstyle === 'undefined' ? 'undefined' : _typeof(jsonstyle)) === "object" ? jsonstyle : JSON.parse(jsonstyle);
        var currentstyle = [];
        _zIndex++;
...
var OLStylesSLD = exports.OLStylesSLD = function OLStylesSLD() {
    var styles = [new _Style2.default.Style({
    ...
    var parseFilterProperty = function parseFilterProperty(filter, feature) {
        ...
        if (featurevalue) {
            switch (filter.operator) {
                case '==':
                    switch (typeof featurevalue === 'undefined' ? 'undefined' : _typeof(featurevalue)) {
                        case 'string':
                            value = filter.value;
...
var OLStylesMeasure = exports.OLStylesMeasure = function OLStylesMeasure() {
    var styles = function styles() {
        return new _Style2.default.Style({
            fill: new _Style2.default.Fill({
