...
exports.newMaplibLayer = exports.default = exports.CapabilitiesUtil = void 0;
...
class CapabilitiesUtil {
  ...
  static getLayersFromWfsCapabilties(capabilities) {
    let nameField = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'name.localPart';
  ...
  static getOlLayerFromWFS(metaCapabilities, capabilities) {
    let nameField = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'name.localPart';
