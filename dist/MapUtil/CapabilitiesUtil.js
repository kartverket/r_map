...
var _swaggerParser = _interopRequireDefault(require("@apidevtools/swagger-parser"));
...
var CapabilitiesUtil = /*#__PURE__*/function () {
  ...
  _createClass(CapabilitiesUtil, null, [{
    ...
    /**
       ...
       */
    function parseFeaturesCapabilities(capabilitiesUrl) {
      /*
      ...
      */
      return fetch(capabilitiesUrl).then(function (response) {
        ...
        var api = _swaggerParser.default.dereference(data);

        return api;
      }).then(function (openapi) {
        console.log(openapi);
        var paths = [];
        var baseUrl = openapi.servers[0].url;
        Object.entries(openapi.paths).forEach(function (entry) {
