...
var _ProjectionUtil = require('./ProjectionUtil');
...
var Map = exports.Map = function Map(mapImplementation, eventHandler, featureInfo) {
    /*
    ...
    function init(targetId, mapConfig) {
        ...
        layerHandler = new _Layers2.default(mapConfig, mapImplementation);
        groupHandler = new _Groups2.default(mapConfig);
        categoryHandler = new _Categories2.default(mapConfig);

        eventHandler.TriggerEvent(_EventHandler.EventTypes.MapLoaded);
        return olMap;
    }

    function _loadCustomCrs() {
        _ProjectionUtil2.default.loadCustomCrs();

        _ProjectionUtil2.default.addCustomProj('EPSG:25832');
        _ProjectionUtil2.default.addCustomProj('EPSG:25833');
        _ProjectionUtil2.default.addCustomProj('EPSG:25834');
        _ProjectionUtil2.default.addCustomProj('EPSG:25835');
        _ProjectionUtil2.default.addCustomProj('EPSG:25836');
        _ProjectionUtil2.default.addCustomProj('EPSG:32632');
        _ProjectionUtil2.default.addCustomProj('EPSG:32633');
        _ProjectionUtil2.default.addCustomProj('EPSG:32634');
        _ProjectionUtil2.default.addCustomProj('EPSG:32635');
        _ProjectionUtil2.default.addCustomProj('EPSG:32636');
        _ProjectionUtil2.default.addCustomProj('EPSG:4258');
    }
