...
exports.getResolutionFromScale = exports.getWMSCapabilities = exports.parseWmsCapabilities = exports.mergeDefaultParams = exports.createOlWMSFromCap = exports.addWmsToMapFromConfig = exports.addWmsToMapFromCap = undefined;
 ...
 */
var addWmsToMapFromCap = exports.addWmsToMapFromCap = function addWmsToMapFromCap(map, getCapLayer) {
...
var addWmsToMapFromConfig = exports.addWmsToMapFromConfig = function addWmsToMapFromConfig(map, wmslayer, project) {
    var isNewLayer = true;
    var returnLayer;
 ...
 */
var createOlWMSFromCap = exports.createOlWMSFromCap = function createOlWMSFromCap(map, getCapLayer, project) {
    var attribution,
        attributionUrl,
        metadata,
        errors = [];
...
var mergeDefaultParams = exports.mergeDefaultParams = function mergeDefaultParams(url, defaultParams) {
    //merge URL parameters with default ones
    var parsedUrl = _queryString2.default.parseUrl(url);
    ...
    return parsedUrl.url + "?" + _queryString2.default.stringify(defaultParams);
};
var parseWmsCapabilities = exports.parseWmsCapabilities = function parseWmsCapabilities(data) {
    if (data && _fastXmlParser2.default.validate(data) === true) {
        //optional
        var parsed = parseCapabilities(data);

        var layers = [];
        if (parsed.WMS_Capabilities) {
            var url = parsed.WMS_Capabilities.Capability.Request.GetMap.DCPType.HTTP.Get.OnlineResource["xlink:href"];
...
var parseCapabilities = function parseCapabilities(xml) {
    return _fastXmlParser2.default.parse(xml, {
...
var getWMSCapabilities = exports.getWMSCapabilities = function () {
    ...
    return function getWMSCapabilities(_x3) {
                ...
                for (var i = 0, ii = results.length; i < ii; i++) {
                    ...
                    if (result) {
                        if (result['code'] && result['code'].length > 0 && result['proj4'] && result['proj4'].length > 0) {
                            _proj2.default.defs('EPSG:' + result['code'], result['proj4']);
                        }
                    }
                }
            }
 ...
 */
var getResolutionFromScale = exports.getResolutionFromScale = function getResolutionFromScale(projection, scale) {
