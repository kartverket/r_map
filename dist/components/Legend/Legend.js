...
var _Legend = _interopRequireDefault(require("./Legend.scss"));
    ...
    value: function legend() {
      ...
      if (this.props.legendUrl) {
        return _react.default.createElement("div", null, _react.default.createElement("div", {
          className: _Legend.default.toggle,
          onClick: function onClick() {
            return _this2.toggleExpand();
          }
        }, _react.default.createElement("span", {
          className: _Legend.default.label
          ...
          className: this.state.expanded ? _Legend.default.legend : _Legend.default.legend + ' ' + _Legend.default.closed
