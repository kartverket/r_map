...
function (_Component) {
  ...
  function BackgroundChooser(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(BackgroundChooser).call(this, props));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setAsBaseLayer", function (baseLayer) {
    ...
    _maplibHelper.eventHandler.RegisterEvent("MapLoaded", function () {
      return _this.setState({
        baseLayers: _maplibHelper.map.GetBaseLayers()
      });
    });
