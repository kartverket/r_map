...
var getCapabilitiesByUuid = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(uuid) {
        var response;
...
var api = function api() {
    ...
    undefined.generateWhat3WordsServiceUrl = function () {
        return url + 'ws/w3w.py';
    };

    undefined.uploadGpxFileService = function () {
        return url + 'ws/upload-gpx.py';
    };

    undefined.generateElevationChartServiceUrl = function (gpxFile) {
    ...
    undefined.generateMapLinkServiceUrl = function (config) {
    ...
    undefined.generateEmergencyPosterServiceUrl = function (config) {
    ...
    undefined.generateSearchMatrikkelVegUrl = function (query) {
        return url + "ws/veg.py?" + encodeURIComponent(query);
    };

    undefined.generateSearchMatrikkelAdresseUrl = function (query) {
        return url + "ws/adr.py?" + encodeURIComponent(query);
    };

    undefined.generateSearchStedsnavnUrl = function (query, side, antall) {
        if (query) {
    ...
    undefined.generateSearchAdresseUrl = function (query) {
        return urlGeonorge + "AdresseWS/adresse/sok?sokestreng=" + encodeURIComponent(query) + "&antPerSide=1000&side=0";
    };

    undefined.generateElevationPointUrl = function (lat, lon, epsgNumber) {
        return url + 'ws/elev.py?lat=' + lat + '&lon=' + lon + '&epsg=' + epsgNumber;
    };

    undefined.generateMatrikkelInfoUrl = function (minx, miny, maxx, maxy) {
        return url + "ws/wfs.teig.py?bbox=" + minx + "," + miny + "," + maxx + "," + maxy;
    };

    undefined.generateSeEiendomUrl = function (knr, gnr, bnr, fnr, snr) {
    ...
    undefined.generateFaktaarkUrl = function (stedsnummer) {
        return urlFaktaark + stedsnummer;
    };

    undefined.generateKoordTransUrl = function (ost, nord, resSosiKoordSys, sosiKoordSys) {
    ...
    undefined.generateGeoJSONUrl = function (hash, save) {
        var params = {};
        params.hash = hash;
        if (save) {
            params.save = true;
    ...
    undefined.generateGeoJSONSaveUrl = function () {
        return url + 'ws/upload-json.py';
    };

    undefined.generateSearchMatrikkelNummerUrl = function (query) {
        return url + 'ws/eie.py?' + encodeURIComponent(query);
    };

    undefined._constructMarkingFilter = function (property) {
    ...
    undefined.generateMatrikkelWfsFilterUrl = function (property) {
        return url + 'ws/wfs.teig.py?' + this._constructMarkingFilter(property);
    };

    undefined.generateEiendomAddress = function (kommunenr, gardsnr, bruksnr, festnr, sectionsnr) {
    ...
    undefined.generateFaqUrl = function (code) {
    ...
    undefined.getSOSIfromEPSG = function (epsg) {
    ...
    undefined.getCoordinateSystems = function (type) {
        var result = {};
    ...
    undefined.isOutOfBounds = function (coordinates) {
        return this.sosiCodes.filter(function (el) {
    ...
    undefined.isNotOutOfBounds = function (coordinates) {
        return this.sosiCodes.filter(function (el) {
            return coordinates.north.value > el.bbox.MinX && coordinates.north.value < el.bbox.MaxX && coordinates.east.value > el.bbox.MinY && coordinates.east.value < el.bbox.MaxY;
        }).map(function (obj) {
            return obj;
