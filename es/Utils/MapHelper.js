 ...
 */
export var addWmsToMapFromCap = function addWmsToMapFromCap(map, getCapLayer) {
...
export var addWmsToMapFromConfig = function addWmsToMapFromConfig(map, wmslayer, project) {
    var isNewLayer = true;
    var returnLayer;
 ...
 */
export var createOlWMSFromCap = function createOlWMSFromCap(map, getCapLayer, project) {
    var attribution,
        attributionUrl,
        metadata,
        errors = [];
...
export var mergeDefaultParams = function mergeDefaultParams(url, defaultParams) {
...
export var parseWmsCapabilities = function parseWmsCapabilities(data) {
    if (data && parser.validate(data) === true) {
        //optional
...
export var getWMSCapabilities = function () {
 ...
 */
export var getResolutionFromScale = function getResolutionFromScale(projection, scale) {
