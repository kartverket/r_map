...
import { GeoJSON as GeoJSONFormat, GML as GMLFormat, WFS as WFSFormat } from 'ol/format';
...
import { bbox as loadingstrategyBbox, tile as loadingstrategyTile } from 'ol/loadingstrategy';
import { get as getProjection } from 'ol/proj.js';

export var MaplibCustomMessageHandler = function MaplibCustomMessageHandler(eventHandler, _getIsySubLayerFromPool) {
    var olMap;
...
export var Wms = function Wms(isySubLayer, parameters) {
    var url;
    var urls;
...
export var Wmts = function Wmts(isySubLayer, parameters) {
...
export var Vector = function Vector(isySubLayer) {
    var source;
...
export var Wfs = function Wfs(isySubLayer, offline, parameters, featureObj, eventHandler) {
    /* jshint -W024 */
    var strategy;
