...
export var OLStylesDefault = function OLStylesDefault() {
...
export var OLStylesJson = function OLStylesJson(style) {
    var _zIndex = 0;
...
export var OLStylesSLD = function OLStylesSLD() {
...
export var OLStylesMeasure = function OLStylesMeasure() {
    var styles = function styles() {
        return new style.Style({
            fill: new style.Fill({
