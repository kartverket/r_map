...
export const OLStylesJson = (style) => {
  var _zIndex = 0;
...
export const OLStylesSLD = () => {
      ...
      UserStyle: function (node, layer) {
        ...
        if (this.multipleSymbolizers) {
          ...
          obj.rules.each(function (item, rule) {
            ...
            var fillstyle; var strokestyle; var imagestyle;
            if (polygonstyle) {
  ...
  var _getValidStyle = function (feature, scale, hover) {
    ...
    var userStyles = [];
    var textstyle; var label; var featurelabel;
  ...
  return {
    ...
    getAttributeNodeNS: function (node, uri, name) {
      ...
      if (node.getAttributeNodeNS) {
        ...
        var potentialNode; var fullName;
