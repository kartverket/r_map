      ...
      if (isNewLayer) {
        ...
        if (currentNode.queryable) {
          window.olMap.on('singleclick', function (evt) {
            ...
            let indexFormat = 0
            if (formats.indexOf('application/vnd.ogc.gml') > 0) { indexFormat = formats.indexOf('application/vnd.ogc.gml') }
            else if (formats.indexOf('text/xml') > 0) { indexFormat = formats.indexOf('text/xml') }
            else if (formats.indexOf('text/plain') > 0) { indexFormat = formats.indexOf('text/plain') }
