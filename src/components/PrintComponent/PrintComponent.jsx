...
const Print = props => {
  const [printCapabilities, setPrintCapabilities] = useState()
  const [maltype, setMaltype] = useState()
  const [selectedPrintScale, setScale] = useState()
  ...
  const makePrint = () => {
    ...
    let printJson = {
      attributes: {
        ...
        pos:
          Number(Math.round(center[0] + "e" + 2) + "e-" + 2) + ", " +
          Number(Math.round(center[1] + "e" + 2) + "e-" + 2),
